...
//    	List<String> permList = StringPermutation.getPermutation("abcdefghi");
    	List<String> permList = StringPermutation.getPermutation("abcdefghij");
        System.out.println("Total Size :::"+permList.size());  
